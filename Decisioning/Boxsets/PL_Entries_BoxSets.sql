/*
*********************************************************************************
** File: PL_Entries_Boxsets.sql
** Name: PL_Entries_Boxsets
** Desc: Code for calculating PLEntires  for "Boxsets"
** Auth: Fractal Team 
** Date: 17/11/2017
************************************************************************************
****                                                            Change History                                                          ****
...
** --           ---------       -------------                   ------------------------------------
** 1            17/11/2017      PL_Entries_Boxsets              First commit
** 2        	03/01/2018  	Vikram Haibate          Add DDL and Procs 
**********************************************************************************

dba.sp_drop_table 'Decisioning','PL_Entries_Boxsets'
dba.sp_create_table 'Decisioning','PL_Entries_Boxsets',
...
GO 
Drop procedure if exists Decisioning_Procs.Update_Decisioning_PL_Entries_Boxsets;
GO 
Create procedure Decisioning_Procs.Update_Decisioning_PL_Entries_Boxsets(Refresh_Dt date default null)
...
BEGIN 
Set Refresh_Dt = (Select max(event_dt) - 2*7 from Decisioning.PL_Entries_Boxsets);
END
End If;

Delete from Decisioning.PL_Entries_Boxsets where Event_Dt >= Refresh_Dt;
...
-- --------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS #PL_Entries_Boxsets;

-- INSERT INTO #PL_Entries_Boxsets (Subs_Year, Subs_Week_Of_Year, Subs_Week_And_Year, Event_Dt, account_number, Country,
...
INSERT INTO Decisioning.PL_Entries_Boxsets 
(Subs_Year,
Subs_Week_Of_Year,
Subs_Week_And_Year,
event_dt,
...
FROM #PL_Entries_Boxsets PL LEFT JOIN Decisioning.Activations_SkyBoxsets ACT
...
END;
GO
Grant Execute on Decisioning_Procs.Update_Decisioning_PL_Entries_Boxsets to Decisioning;

/* ======================================== Queries for Testing ========================================
call Decisioning_Procs.Update_Decisioning_PL_Entries_Boxsets('2017-10-01');
SELECT TOP 1000 * FROM Decisioning.PL_Entries_Boxsets;
select count(*) from Decisioning.PL_Entries_Boxsets;



call DBA.sp_DDL ('drop', 'view', 'CITeam', 'PL_Entries_Boxsets');
call DBA.sp_DDL ('create', 'view', 'CITeam', 'PL_Entries_Boxsets',  'select * from Decisioning.PL_Entries_Boxsets');
====================================================================================================== */
