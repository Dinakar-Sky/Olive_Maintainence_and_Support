...
dba.sp_drop_table 'CITeam','Churn_BBBOOST_beta'
dba.sp_create_table 'CITeam','Churn_BBBOOST_beta',
...
*/
/* =================================================================================== */
DROP TABLE IF EXISTS CITea.Churn_BBBoost_beta;
CREATE TABLE aks03.Churn_BBBoost_beta(
Subs_Year            decimal (       22      )       default null,
Subs_Week_Of_Year            decimal (       22      )       default null,
Subs_Week_And_Year           varchar (       6       )       default null,
Event_Dt             date                            default null,
...
Drop procedure if exists aks03.Update_Decisioning_Churn_BBBOOST;
GO
-- Create procedure Decisioning_Procs.Update_Decisioning_Churn_BBBOOST(Refresh_Dt date default null)
Create procedure aks03.Update_Decisioning_Churn_BBBOOST(Refresh_Dt date default null)
...
Delete from CITeam.Churn_BBBoost_beta where Event_Dt >= Refresh_Dt;
...
INSERT INTO CITeam.Churn_BBBoost_beta (
...
Grant Execute on aks03.Update_Decisioning_Churn_BBBOOST to Decisioning;
...
====================================================================================================== 
*/
select distinct current_product_description from CITeam.Churn_BBBoost_beta