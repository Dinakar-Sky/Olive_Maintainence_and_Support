...
GO
DROP PROCEDURE if exists Decisioning_procs.Add_Active_Subscriber_Product_Holding
GO
...
begin
  ...
  set Dynamic_SQL = substr(Dynamic_SQL,1,len(Dynamic_SQL)-1)
	...
	when 'UOD' then 'ULTIMATE_OD_STREAMING_PRODUCTS' 
...
GO
GRANT EXECUTE ON Decisioning_procs.Add_Active_Subscriber_Product_Holding TO public;