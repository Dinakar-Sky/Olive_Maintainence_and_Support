...
begin
  ...
  set prod_type
    ...
    when str_replace(lower(prod_type),' ','_') in( 'hd premium','hd_pack','hd_sports' ) then 'HD_PREMIUM'
    ...
    when str_replace(upper(prod_type),' ','_') in( 'KIDS','SKYKIDS','SKY KIDS' ) then 'KIDS' end;
