...
------------- */
   ...
   /* drop table if exists #single_account;
    select a.account_number,
      max(a.cust_ctor_src_system_id) as party_id -- !!cust_ctor_src_system_id
      into #single_account
      from cust_single_account_view as a
        join Decisioning.Propensity_Model_Mart as b --copied from Jet18.clv_output_for_rs table to Decisioning schema
        on a.account_number = b.account_number
      group by a.account_number;

    drop table if exists #single_account2;

    select a.account_number,
      a.party_id,
      b.owning_cust_account_id
      into #single_account2
      from #single_account as a
    ...
    update Decisioning.Propensity_Model_Mart as a
      set a.party_id = b.party_id,
      a.owning_cust_account_id = c.owning_cust_account_id from
      Decisioning.Propensity_Model_Mart as a
      left outer join #single_account as b
      on a.account_number = b.account_number
      left outer join #single_account2 as c
